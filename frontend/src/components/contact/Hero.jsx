      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Get in touch with our certified Quran teachers and start your spiritual learning journey today
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-amber-600 font-semibold text-lg">+997 979 797</p>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 font-semibold text-lg">+997 979 797</p>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 font-semibold text-lg">onlinequran234@gmail.com</p>
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Get Free Trial</h2>
              <p className="text-gray-600">Fill the form below to get your first free Quran class</p>
            </div>
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300"
              ...
              <div className="relative">
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 h-32 resize-none"
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 text-lg"
              >
