...
const Testomonial = () => {
  ...
  return (
    <div className="px-4 sm:px-6 py-10 mb-5 bg-gradient-to-br from-[#644E38] to-[#D4B183]  max-w-full">
      <h1 className="text-center text-2xl md:text-4xl font-semibold mb-6 text-white">
        What Our Students Say
      </h1>

      <p className="text-center flex items-center justify-center gap-4 text-lg font-semibold text-yellow-200">
          ...
          {TestomonialArray.map((item) => (
            ...
            >
              ...
              <div className="text-center md:text-left">
                ...
                <p className="italic text-black mb-4">"{item.msg}"</p>
      ...
      {/* Dots Navigation */}
      <div className="flex justify-center items-center gap-2 mt-8 text-2xl text-yellow-500">
