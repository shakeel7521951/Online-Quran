        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          {!isLogin && (
            <div>
              ...
              <input
                ...
                className={`w-full border ${errors.name ? "border-red-500" : "border-gray-300"} rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#D4AF37] focus:outline-none`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#D4AF37] focus:outline-none`}
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full border ${errors.password ? "border-red-500" : "border-gray-300"} rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#D4AF37] focus:outline-none pr-10`}
              placeholder="••••••••"
            />
            <button
              type="button"
          ...
          {!isLogin && (
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full border ${errors.confirmPassword ? "border-red-500" : "border-gray-300"} rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#D4AF37] focus:outline-none pr-10`}
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <button
            ...
            className={`w-full bg-[#0E7C5A] text-white py-2.5 rounded-lg font-semibold hover:bg-emerald-700 transition-colors ${isSubmitting ? "opacity-75 cursor-not-allowed" : ""}`}
          >
