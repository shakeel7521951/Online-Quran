        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          >
            <div className="text-center">
              ...
              <button className="w-full bg-[#D4AF37] hover:bg-[#C19B2E] text-black font-semibold py-3 px-4 rounded-lg transition-all duration-200 hover:scale-[1.02] shadow-md">
                Claim Free Trial
              </button>
