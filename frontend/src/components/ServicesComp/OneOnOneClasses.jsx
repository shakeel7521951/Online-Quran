      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-center">
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block px-6 py-3 sm:px-8 sm:py-3 md:px-10 md:py-4 rounded-2xl sm:rounded-3xl text-white bg-[#D4AF37] font-medium text-sm sm:text-base md:text-lg shadow-lg transition"
          >
