...
const ProgressStats = () => {
  ...
  const stats = [
    ...
    { value: 50, suffix: "+", label: "Satisfied Clients", animation: "fade-down", delay: 150 },
    { value: 17, suffix: "+", label: "Countries We Operate", animation: "fade-up", delay: 300 },
    { value: 200, suffix: "K+", label: "Managed Marketing ", animation: "fade-down", delay: 450 },
    { value: 2.9, suffix: "M+", label: "Clients Gain", animation: "fade-up", delay: 600 },
  ];
  ...
  return (
    <section className="bg-gray-100 py-16 px-4 overflow-hidden">
      ...
      >
        ...
        <span className="text-gray-600 text-sm">(Surah An-Najm 53:39)</span>
      </p>
      ...
      >
        TOJO GLOBAL connects your business directly to your target audience, eliminating the need to search for clients. With us, they'll find their way to you.
      </p>
...
const StatCard = ({ stat, index }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm mt-2 px-2 tracking-wide text-gray-200 transition-all duration-300 group-hover:translate-y-1">
        {stat.label}
      </p>
    </div>
  );
