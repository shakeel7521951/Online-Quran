    ...
    <section className="w-full bg-[#F8F5E6] py-20 px-4 md:px-8 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2
            className="text-4xl md:text-5xl font-bold mb-4 leading-tight font-serif text-[#2C3E50]"
            data-aos="fade-down"
          >
            ...
            <div className="flex items-start gap-6 group" data-aos="fade-right">
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <span style={{ color: ACCENT }}>&quot;Register Online&quot;</span>. Fill
            ...
            >
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <span style={{ color: ACCENT }}>first class</span> with our qualified
