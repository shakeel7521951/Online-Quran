...
const QuranCourses = () => {
  ...
  const mainCourses = [
    ...
    },
    {
      ...
      detailedDescription:
        "Our Hifz program follows a structured methodology to help students memorize the Quran with proper Tajweed and understanding. We use proven techniques that make memorization easier and retention stronger. Regular revision schedules ensure that memorized portions remain fresh in memory.",
      features: [
    ...
    },
    {
      ...
      detailedDescription:
        "This course delves into the meanings and explanations of the Quranic verses. You'll learn about the context of revelation, linguistic nuances, and wisdom behind the verses. Our scholars provide insights from classical and contemporary Tafseer works to help you develop a deeper understanding of Allah's message.",
      features: [
  ...
  return (
    <div className="bg-gradient-to-b from-white via-emerald-50 to-white py-20 px-6 md:px-10">
            ...
            {mainCourses.map((course, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden" data-aos="zoom-in">
                  ...
                  <h3
                    className="absolute bottom-4 left-4 text-lg font-bold text-white drop-shadow-lg group-hover:text-emerald-200 transition-all duration-300"
                    data-aos="fade-right"
                  >
                    {course.title}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {faqCourses.map((course, index) => (
              ...
              >
                ...
                <div className="pl-5">
                  <h3
                    className="font-semibold text-lg text-emerald-900 mb-3 group-hover:text-emerald-700 transition-colors duration-300"
                    data-aos="fade-right"
                  >
                    {course.title}
                  </h3>
      ...
      {selectedCourse && (
        <div
          className="fixed inset-0 bg-black/80 bg-opacity-0 flex items-center justify-center p-4 z-50"
          data-aos="zoom-in"
        >
          <div
              ...
              <div className="mb-5" data-aos="fade-left">
                ...
                <ul className="list-disc pl-5 text-gray-700">
                  {selectedCourse.features.map((feature, index) => (
                    <li key={index} className="mb-1" data-aos="fade-up">
                      {feature}
                    </li>
                  ))}
                </ul>
