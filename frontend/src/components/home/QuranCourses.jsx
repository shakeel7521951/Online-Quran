...
//                   <h3 className="absolute bottom-4 left-4 text-lg font-bold text-white drop-shadow-lg hover:text-[#0E7C5A] transition-all duration-300">
//                     {course.title}
//                   </h3>
//                 </div>
...
//               <div
//                 key={index}
//                 className="relative bg-gradient-to-br from-white to-emerald-50 rounded-2xl p-6 border border-emerald-100 shadow-md hover:shadow-2xl  transform hover:-translate-y-2 transition-all duration-500 group"
//                 data-aos="fade-up"
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 hover:shadow-lg"
                    style={{
                      background: `linear-gradient(135deg, ${PRIMARY}, ${ACCENT})`,
                      color: "#fff",
                    }}
